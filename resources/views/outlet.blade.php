...
<main class="px-5 pt-5" style="margin-top: 3em; gap: 2em; display: flex; align-items:center; flex-direction:column">  
  ...
  <div style="display: flex; gap: 2em; ">
    <x-outlet-buttons>Gate 1</x-outlet-buttons>
    <x-outlet-buttons>Gate 2</x-outlet-buttons>
    <x-outlet-buttons>Gate 3</x-outlet-buttons>
    <x-outlet-buttons>Gate 4</x-outlet-buttons>
  </div>
</main>
...
<div style="width: 100vw; background: #FFEEEB; padding: 5em; margin-top: 3em; display:flex; justify-content:space-between; align-items:center">
  ...
  <div style="width: 80vw; overflow-x:auto; justify-content: center; align-items:center; display:flex; gap:1em; font-size: 13px">
    {{--  --}}
    <x-outlet-items gate="Gate 1" title="Warung Mas Gandhi" image="./asset/foodholder.png" harga="10k - 20k" desc="Outlet yang menyediakan aneka masakan sambelan seperti sambal tomat, bawang dan ijo dengan beraneka macam lauk crispy" />
    <x-outlet-items gate="Gate 1" title="Nasi Campur Cak Devon" image="./asset/NasiCampur.png" harga="8k - 15k" desc="Outlet yang menyediakan aneka nasi campur, nasi kuning, nasi pecel, dan juga nasi uduk yang siap menemani rasa lapar di perut Anda" />
    <x-outlet-items gate="Gate 1" title="Soto Mbok Ayu" image="./asset/soto-sate.png" harga="12k - 18k" desc="Outlet yang menyajikan soto dengan beraneka macam topping yang siap menemani sarapan maupun makan siang Anda" />
  </div>
