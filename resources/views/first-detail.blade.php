...
<div style="width:100%; display:flex; flex-direction:column; align-items:center" class="p-5">
    ...
    <div style="display: flex; justify-content:flex-start; align-items:center; flex-direction:row; gap:1.5em">
      ...
      <div>
        ...
        <div style="display gap: 1em; align-items:center; color:#F05A32">
          <h2 class="price" style="color: #B02929">Rp13.000</h2>
        </div>
      </div>
    </div>
    <div style="">
      ...
      <div style="border-radius:0.3em; background:#EDEDED; padding:1px; display:flex; justify-content:center">
        <div style="color: #B02929; cursor: pointer; user-select: none;" class="p-3 minus">
          -
        </div>
        <input type="text" class="px-4 py-3 quantity" style="background:white; width: 100px; text-align: center;" value="1">
        <div style="color: #B02929; cursor: pointer; user-select: none;" class="p-3 plus">
          +
        </div>
      </div>
  ...
  <div class="m-4" style="width: 90%;display:flex; gap: 1em; align-items:center; justify-content:space-between">
    ...
    <p style="font-size: large" class="total-price">Rp13.000</p>
  </div>
  ...
  <div class="m-4" style="width: 90%;display:flex; gap: 1em; align-items:center; justify-content:space-between">
    ...
    <h5 style="font-size: large" class="total-price">Rp13.000</h5> 
  </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTotalPrice() {
      let price = parseInt(priceDisplay.textContent.replace('Rp', '').replace('.', ''));
      let quantity = parseInt(quantityInput.value);
      let totalPrice = price * quantity;
      let formattedTotalPrice = 'Rp' + totalPrice.toLocaleString();
      totalPriceDisplay.forEach(element => {
        element.textContent = formattedTotalPrice;
      });
    }
