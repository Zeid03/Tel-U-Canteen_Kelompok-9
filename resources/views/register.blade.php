  ...
  <div style="width:100vw; height:100vh; display:flex;">
    ...
    <div style="box-sizing:border-box; flex:1;background: white; display:flex; flex-direction:column; justify-content:space-between; padding:5em; align-items:center">
      <div style="display: flex; flex-direction:column; align-items:center;">
        <h2 style="text-align: center">Lakukan <br>
            <span style="color:#B02929">Pendaftaran</span></h2>
          <p>Silahkan isi data di bawah ini untuk melanjutkan</p>
          <form action="#" class="mt-5">
            <h5>Nama</h5>
            <input class="lool" placeholder="Masukan nama anda" type="text">
            <h5>Email</h5>
            <input class="lool" placeholder="Masukan email anda" type="text">
          </form>
      </div>
