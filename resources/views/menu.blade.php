...
<main class="px-5 mt-5 pt-5" style="gap: 2em; display: flex; align-items:center; flex-direction:column">  
  ...
  <div style="display: flex; gap: 2em; ">
    <x-outlet-buttons>Aneka Nasi</x-outlet-buttons>
    <x-outlet-buttons>Sup & Soto</x-outlet-buttons>
    <x-outlet-buttons>Mie</x-outlet-buttons>
    <x-outlet-buttons>Aneka Sayur</x-outlet-buttons>
    <x-outlet-buttons>Minuman</x-outlet-buttons>
  </div>
...
<div style="margin-left: 8em; background: #FFF1E4; padding: 2em; margin-top: 3em; display:flex; flex-wrap:wrap; gap: 2em; border-radius: 20px; text-align: justify; width: 100%; font-size: 12px">
  <x-menu-items jumlah="10" title="Nasi Campur" desc="Masakan khas Indonesia. yang terdiri atas nasi putih yang dihidangkan dengan bermacam-macam lauk." image="./asset/Nasi Campur.png"/>
  <x-menu-items jumlah="10" title="Nasi Goreng" desc="Makanan berupa nasi yang digoreng dan dicampur dalam minyak goreng, margarin atau mentega." image="./asset/Nasi Goreng.png"/>
  <x-menu-items jumlah="10" title="Nasi Uduk" desc="Nasi putih yang diaron & dikukus dengan santan, dibumbui dengan pala, kayu manis, jahe, daun serai dan merica." image="./asset/Nasi Uduk.png"/>
  <x-menu-items jumlah="10" title="Nasi Kuning" desc="Masakan khas Indonesia yang terbuat dari beras yang dimasak bersama kunyit serta santan dan rempah-rempah." image="./asset/Nasi Kuning.png"/>
  <x-menu-items jumlah="10" title="Nasi Bakar" desc="Nasi yang diberi beberapa bumbu dan lauk, dibungkus daun pisang, lalu dibakar di atas api arang." image="./asset/Nasi Bakar.png"/>
  <x-menu-items jumlah="10" title="Nasi Pecel" desc="Makanan yang dihidangkan dengan bumbu sambal kacang dan dicampur dengan aneka jenis sayuran." image="./asset/Nasi Pecel.png"/>
...
<div style="display: flex; justify-content: center; flex-direction:column; gap: 1em" class="p-5 mt-5">
  ...
  <div style="display:flex; justify-content:space-around;">
    ...
    <x-favorites color="green" image="./asset/tahu-telor.png" title="Tahu Telor"/>
    <x-favorites color="yellow" image="./asset/NasiCampur.png" title="Nasi Campur"/>
    {{--  --}}
  </div>
</div>
